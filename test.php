...
if (array_key_exists('email', $_POST)) {
    ...
    $mail->setFrom('p@pdillo.com', 'Phillip Dillon');
    ...
    $addresses = [
        'sales' => 'p@pdillo.com',
        'support' => 'p@pdillo.com',
        'accounts' => 'p@pdillo.com',
    ];
...
EOT;
        ...
        if (!$mail->send()) {
            ...
            $response = [
                "status" => false,
                "message" => 'Sorry, something went wrong. Please try again later.' . $mail->ErrorInfo
            ];
        } else {
            $response = [
                "status" => true,
